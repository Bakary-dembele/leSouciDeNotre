 ...
 */
final class Version20210409213525 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE collecte ADD details VARCHAR(255) DEFAULT NULL, ADD date_heure DATETIME NOT NULL, ADD adresse VARCHAR(255) NOT NULL, ADD referent VARCHAR(255) NOT NULL, ADD nombre_de_places VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE collecte DROP details, DROP date_heure, DROP adresse, DROP referent, DROP nombre_de_places');
    }
}
